...
class SignUp extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <h1>Sign Up</h1>
        <p className="loginBtn loginBtn--google"><a onClick={authInProgress} className="google-anchor" href="http://localhost:3000/api/auth/google">Sign Up with Google</a></p>
...
export default connect(mapStateToProps, {authInProgress, authSuccess, authCompleted, authFailure})(SignUp);